...
const ID_TO_CODE = {
  ...
  '3904':'arg.2','3913':'den.1','3928':'fin.1','3930':'irl.1','3932':'mex.2',
  '3934':'par.1','3939':'rus.1','3943':'nor.1','3945':'swe.1','4002':'usa.2',
...
function resolveLeagueFromName(name) {
  ...
  if ((n.includes('women') || n.includes('wnations') || n.includes('wafcon')) &&
      (n.includes('africa') || n.includes('afcon') || n.includes('nations')))
                                                                        return 'caf.wnations';

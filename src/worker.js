...
const TTL_LIVE      = () => 120 + Math.floor(Math.random() * 61); // 2–3 دقائق عشوائية
const TTL_MATCHES   = 300;
const TTL_ROUND_MATCHES = 4 * 3600; // 4 ساعات — مباريات جولة league.html (بلا مباشر)
const TTL_SUMMARY   = () => 600 + Math.floor(Math.random() * 301); // 10–15 دقيقة عشوائية للإحصاءات
const TTL_FORMATION = 4 * 3600; // 4 ساعات — التشكيلة لا تتغير أثناء المباراة
const TTL_FINISHED  = null; // تخزين دائم — المباراة المنتهية لا تتغير أبداً
const TTL_STANDINGS = 21600;
const TTL_SCORERS   = 21600;
const TTL_SCORERS_BACKUP = 7 * 86400; // نسخة احتياطية للهدافين تُعرض بدل رسالة فارغة
...
async function kvPut(env, key, value, ttl) {
  try {
    const opts = ttl ? { expirationTtl: ttl } : {}; // بدون ttl = تخزين دائم
...
const CONTINENTAL_RULES = {
  ...
  // أمريكا الشمالية — بلايوف
  'usa.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#81D6AC',5:'#81D6AC',6:'#81D6AC',7:'#81D6AC' },
  'can.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#81D6AC' },
  'mex.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#81D6AC',5:'#81D6AC',6:'#81D6AC',7:'#81D6AC',8:'#81D6AC' },
  // أوقيانوسيا وآسيا
  'aus.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#81D6AC',5:'#81D6AC',6:'#81D6AC','-1':'#FF7F84','-2':'#FF7F84' },
  'tha.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'idn.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'ind.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#81D6AC',5:'#81D6AC',6:'#81D6AC' },
  // أفريقيا — إضافة
  'nga.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'rsa.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC','-1':'#FF7F84','-2':'#FF7F84' },
  'gha.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  // أمريكا الجنوبية
  'chi.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#81D6AC',5:'#81D6AC',6:'#81D6AC',7:'#81D6AC',8:'#81D6AC','-1':'#FF7F84','-2':'#FF7F84' },
  'col.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#81D6AC',5:'#81D6AC',6:'#81D6AC',7:'#81D6AC',8:'#81D6AC','-1':'#FF7F84','-2':'#FF7F84' },
  'ecu.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#81D6AC',5:'#81D6AC',6:'#81D6AC',7:'#81D6AC',8:'#81D6AC','-1':'#FF7F84','-2':'#FF7F84' },
  'per.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#81D6AC',5:'#81D6AC',6:'#81D6AC',7:'#81D6AC',8:'#81D6AC','-1':'#FF7F84','-2':'#FF7F84' },
  'par.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84' },
  'uru.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#81D6AC',5:'#81D6AC',6:'#81D6AC',7:'#81D6AC',8:'#81D6AC','-1':'#FF7F84','-2':'#FF7F84' },
  'ven.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#81D6AC',5:'#81D6AC',6:'#81D6AC',7:'#81D6AC',8:'#81D6AC','-1':'#FF7F84','-2':'#FF7F84' },
  'bol.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  // أوروبا — إضافة
  'irl.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84' },
  'svk.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'svn.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84' },
  'cze.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'pol.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'hun.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'bul.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'cro.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'srb.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'ukr.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'rus.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#81D6AC',4:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'den.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'nor.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'swe.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'fin.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'aut.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'sui.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
  'rou.1':  { 1:'#81D6AC',2:'#81D6AC',3:'#6CABDD','-1':'#FF7F84','-2':'#FF7F84','-3':'#FF7F84' },
};
...
async function resolveLeagueSlug(leagueId, env, nameHint = '') {
  ...
  // نفحص الجدول الثابت أولاً قبل KV — يمنع بيانات KV القديمة الفاسدة
  if (ID_TO_CODE[s]) {
  ...
  try {
    ...
    // نرفض أي قيمة مخزنة إذا كانت `eng.1` لأنها غالبًا ناتجة عن خطأ سابق
  ...
  // لم نجد كودًا حرفيًا حقيقيًا من ESPN — نُرجع معرّفًا مجهولاً بدلاً من eng.1
  // هذا يمنع عرض بيانات البريميرليغ الخاطئة لدوريات غير معروفة
  const byName = resolveLeagueFromName(nameHint || '');
  if (byName) {
...
async function handleSummary(url, env) {
  ...
  if (cachedStats) {
    // الإحصاءات موجودة — تحقق إن كانت التشكيلة مخزّنة منفصلة وادمجها
    const cachedForm = await kvGet(env, kvKeyForm);
    if (cachedForm) {
      return jsonResp({ ...cachedStats, ...cachedForm, fromCache: true });
    }
  ...
  try {
    ...
    if (statusState === 'in') {
      // مباراة مباشرة: التشكيلة مرة واحدة (4 ساعات) + الإحصاءات 10-15 دقيقة
      const formData = {
        homeFormation: result.homeFormation, awayFormation: result.awayFormation,
        homeLineup: result.homeLineup,       awayLineup: result.awayLineup,
      };
      const statsData = { ...result };
      delete statsData.homeFormation; delete statsData.awayFormation;
      delete statsData.homeLineup;    delete statsData.awayLineup;
      ...
      // مباراة منتهية: كل شيء معاً بـ TTL طويلة
...
async function handleStandings(url, env) {
  ...
  // ✅ إصلاح: جرّب مواسم متعددة — الموسم الجديد قد لا يبدأ حتى أغسطس
  const seasonHint = SEASON_OVERRIDE[league];
  const seasonsToTry = seasonHint
    ? [seasonHint, '2025', '2024']
    : ['2026', '2025', '2024', '2023'];
  const urls = [
    ...seasonsToTry.map(s => `${ESPN_STAND}/${league}/standings?season=${s}`),
    `${ESPN_STAND}/${league}/standings`,
    ...seasonsToTry.map(s => `https://site.api.espn.com/apis/v2/sports/soccer/${league}/standings?season=${s}`),
  ];
  let data = null;
  for (const u of urls) {
    try {
      ...
      if (!res.ok) continue;
      const d = await res.json();
      // ✅ إصلاح: اشترط وجود فرق فعلية، ليس مجرد children فارغة
      if ((d.children || []).some(c => (c.standings?.entries || []).length > 0)) {
        data = d; break;
      }
    } catch { continue; }
  }
...
// ── /api/scorers ───────────────────────────────────────────────
// استخراج الهدافين من أي شكل ممكن لـ ESPN
function extractScorers(data) {
  const mapLeaders = (arr) => arr.map((l, i) => ({
    rank: i + 1,
    name: l.athlete?.displayName || l.displayName || l.name || '',
    photo: l.athlete?.headshot?.href || l.athlete?.flag?.href || '',
  ...
  const isGoalCat = (s) =>
    ...
    (s.shortDisplayName||'').toUpperCase() === 'G';

  // ① data.stats[] أو data.categories[] أو data.results.categories[]
  for (const key of ['stats','statistics','categories']) {
    const list = data[key] || data.results?.[key] || [];
    if (list.length) {
      const cat = list.find(isGoalCat) || list[0];
      const leaders = cat?.leaders || cat?.athletes || [];
      if (leaders.length) return mapLeaders(leaders);
    }
  }

  // ② data.leaders[] = [{name,leaders:[]},...] — شكل leaders endpoint
  const leadersList = data.leaders || data.results?.leaders || [];
  if (leadersList.length) {
    const cat = leadersList.find(c => isGoalCat(c)) || leadersList[0];
    const inner = cat?.leaders || cat?.athletes || cat?.items || [];
    if (inner.length) return mapLeaders(inner);
  }

  // ③ ESPN core API: data.items[{athlete,statistics[{name,value}]}]
  const coreItems = data.items || [];
  if (coreItems.length && coreItems[0]?.athlete) {
    return coreItems.map((it, i) => {
      const goalStat = (it.statistics || []).find(s =>
        (s.name||'').toLowerCase().includes('goal') || s.abbreviation === 'G'
      );
      return {
        rank: i + 1,
        name: it.athlete?.displayName || '',
        photo: it.athlete?.headshot?.href || '',
        team: it.team?.displayName || it.athlete?.team?.displayName || '',
        teamLogo: it.team?.logos?.[0]?.href || it.athlete?.team?.logos?.[0]?.href || '',
        goals: parseInt(goalStat?.value ?? goalStat?.displayValue ?? it.value) || 0,
      };
    });
  }
...
async function handleScorers(url, env) {
  ...
  // لا توجد نسخة حديثة — جرّب النسخة الاحتياطية القديمة (حتى 7 أيام) بدل رسالة فارغة
  ...
  // ✅ لا نجلب من ESPN هنا — ESPN يحظر طلبات الـ Worker
  // المتصفح سيجلب مباشرة من ESPN ثم يخزن النتيجة عبر POST /api/scorers-set
...
async function handleLeagueMatches(url, env) {
  ...
  // ✅ لا نجلب من ESPN هنا — ESPN يحظر طلبات الـ Worker
  // المتصفح سيجلب مباشرة من ESPN ثم يخزن النتيجة عبر POST /api/matches-set
...
async function handleLeagueRounds(url, env) {
  ...
  if (cached) return jsonResp({ ...cached, fromCache: true });
  // ✅ لا نجلب من ESPN هنا — ESPN يحظر طلبات الـ Worker
  // المتصفح سيجلب مباشرة من ESPN ثم يخزن النتيجة عبر POST /api/rounds-set
  return jsonResp({ noCache: true, league, season, kvKey });
}

// ── POST /api/scorers-set — يستقبل بيانات الهدافين من المتصفح ──
async function handleScorersSet(url, env, request) {
  ...
  try {
    ...
    const kvKey = `scorers_v8_${league}_${season}`;
    // مدة تخزين ذكية من المتصفح (مبنية على جدول مباريات اليوم) إن وُجدت،
    // بحدود أمان [5 دقائق .. 24 ساعة]، وإلا المدة الافتراضية الثابتة
    const ttl = (Number.isFinite(ttlParam) && ttlParam > 0)
      ? Math.min(Math.max(ttlParam, 300), 86400)
      : TTL_SCORERS;
    await kvPut(env, kvKey, body, ttl);
    // نسخة احتياطية طويلة الأمد — تُستخدم فقط إن انتهت صلاحية النسخة العادية
    // ولم يكن الوقت مناسبًا للجلب الفوري (مثلاً أثناء مباراة مباشرة)
    const backupKey = `scorers_backup_${league}_${season}`;
...
// ── POST /api/rounds-set — يستقبل بيانات الجولات من المتصفح ────
...
// ── POST /api/matches-set — يستقبل بيانات المباريات من المتصفح ─
async function handleMatchesSet(url, env, request) {
  ...
  try {
    const body = await request.json();
    // TTL: جولة فيها مباراة مباشرة الآن → دقيقة واحدة (تحديث سريع)
    // جولة بلا مباريات مباشرة → بضع ساعات (لا داعي لإعادة الجلب أكثر من ذلك)
...
export default {
  async fetch(request, env) {
    ...
    // ── POST: تخزين البيانات المجلوبة من المتصفح في KV ────────────

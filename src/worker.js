...
const ID_TO_CODE = {
  ...
  '33':'aus.1','34':'aut.1','44':'sco.1','45':'nir.1','46':'wal.1',
  '67':'gre.1','71':'tur.1','73':'uefa.euro','74':'uefa.euroq',
  '102':'fra.2','105':'por.1','106':'por.2','112':'rus.1',
  '116':'swe.1','117':'nor.1','118':'fin.1','119':'den.1',
  '120':'cze.1','121':'pol.1','122':'sui.1','123':'srb.1','124':'cro.1',
  '125':'bul.1','126':'hun.1','127':'ukr.1',
  // ESPN alternate IDs for European leagues
  '239':'eng.1','301':'esp.1','302':'ger.1','303':'ita.1','304':'fra.1',
  '305':'ned.1','306':'por.1','307':'bel.1','308':'tur.1','309':'sco.1',
  '336':'aut.1','338':'sui.1','339':'den.1','340':'nor.1','341':'swe.1',
  '342':'pol.1','343':'cze.1','344':'ukr.1','345':'cro.1','346':'srb.1',
  '347':'bul.1','348':'hun.1','349':'rou.1','350':'svk.1','351':'gre.1',
  '352':'irl.1','353':'nir.1','354':'wal.1','355':'rus.1','356':'fin.1',
  '357':'bel.1','358':'ger.2','359':'esp.2','360':'ita.2','361':'fra.2',
  '362':'eng.2','363':'eng.3','364':'eng.4','365':'eng.5','366':'nor.1',
  // ── Americas ──
  '21':'usa.1','22':'arg.1','80':'arg.1',
  '83':'conmebol.copa','85':'fifa.worldq','86':'concacaf.gold',
  '98':'usa.1','131':'mex.1','135':'bra.1','137':'chi.1',
  '141':'col.1','143':'bol.1','147':'ecu.1','150':'par.1',
  '153':'per.1','156':'uru.1','159':'ven.1','174':'mex.1',
  // ESPN alternate IDs for American leagues
  '230':'bra.1','256':'arg.1','257':'mex.1','258':'usa.1','259':'col.1',
  '260':'chi.1','261':'ecu.1','262':'uru.1','263':'per.1','264':'bol.1',
  '265':'par.1','266':'ven.1','267':'bra.2','268':'arg.2',
  '481':'mex.1','482':'usa.1','590':'bra.1',
  // LigaPro Ecuador — ESPN uses multiple IDs
  '660':'ecu.1','661':'ecu.1','662':'ecu.1',
  // Other South/Central American
  '400':'conmebol.libertadores','401':'conmebol.sudamericana',
  '403':'conmebol.america','481':'mex.1','485':'usa.2',
  '486':'can.1','487':'concacaf.champions','488':'concacaf.gold',
  // ── Asia & Oceania ──
  '163':'jpn.1','167':'kor.1','171':'chn.1','178':'tha.1','180':'idn.1',
  '84':'afc.asian.cup',
  // ESPN alternate IDs for Asian leagues
  '298':'jpn.1','299':'kor.1','300':'chn.1','443':'tha.1','444':'idn.1',
  '445':'ind.1','446':'aus.1','447':'jpn.1','448':'kor.1',
  // ── Middle East ──
  '93':'ksa.1','181':'sau.1','186':'uae.1','190':'qat.1',
  // ESPN alternate IDs for Middle East
  '418':'sau.1','419':'ksa.1','420':'uae.1','421':'qat.1',
  '422':'irn.1','423':'irq.1','424':'jor.1','425':'kuw.1',
  // ── Africa ──
  '48':'caf.nations','49':'caf.nations_qual',
  '231':'mar.1','232':'tun.1','233':'alg.1','234':'egy.1',
  '235':'rsa.1','236':'nga.1',
  // ESPN alternate IDs for African leagues
  '380':'egy.1','381':'mar.1','382':'tun.1','383':'alg.1',
  '384':'nga.1','385':'rsa.1','386':'caf.champions','387':'caf.confed',
  // ── Continental / International ──
  '40':'conmebol.libertadores','81':'conmebol.sudamericana',
  ...
  '2026':'fifa.worldq','2027':'fifa.worldq','2028':'fifa.worldq',
  '2029':'fifa.worldq','2030':'fifa.worldq','2031':'fifa.worldq',
};

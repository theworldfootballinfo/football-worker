...
// ESPN's legacy site.api host returns 403 from hosted/server IPs.
// site.web.api exposes the same JSON endpoints and works from Workers.
...
async function resolveLeagueSlug(leagueId, env) {
  ...
  try {
    ...
    const res = await fetch(
      `https://site.web.api.espn.com/apis/site/v2/sports/soccer/all/scoreboard?dates=${today}&limit=500`,
